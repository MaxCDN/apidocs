...
## Changelog
  - **2016-06-28**  Added the ability to block HTTP referers
  - **2016-06-20**  Added multiple levels of compression
...
{% include account-reseller.md %}

{% include users-reseller.md %}

{% include zones-reseller.md %}

{% include reports-reseller.md %}

{% include rawlogs-reseller.md %}

{% include originshield-reseller.md %}

{% include ssl-reseller.md %}
